...
public class UsaFuncionario {
    public static void main(String[] args) {
        ...
        System.out.print("Deseja adicionar atividades esportivas? (S/N): ");
        String adicionarAtividadesEsportivas = scanner.nextLine();
        while (adicionarAtividadesEsportivas.equalsIgnoreCase("S")) {
            System.out.print("Atividade esportiva: ");
            String nomeAtividadeEsportiva = scanner.nextLine();
            System.out.print("Descrição da atividade esportiva: ");
            String descricaoAtividadeEsportiva = scanner.nextLine();
            
            Associado atividadeEsportiva = new Associado(nomeAtividadeEsportiva, descricaoAtividadeEsportiva, descricaoAtividadeEsportiva, descricaoAtividadeEsportiva, descricaoAtividadeEsportiva, descricaoAtividadeEsportiva, descricaoAtividadeEsportiva);
            associado.adicionarAtividadeEsportiva(atividadeEsportiva);

            System.out.print("Deseja adicionar mais atividades esportivas? (S/N): ");
            adicionarAtividadesEsportivas = scanner.nextLine();
        }
        ...
        if (!atividadesEsportivas.isEmpty()) {
            ...
            for (Associado atividadeEsportiva : atividadesEsportivas) {
                ...
                System.out.println("Descrição da atividade esportiva: " + atividadeEsportiva.getEndereco());                
            }
        }

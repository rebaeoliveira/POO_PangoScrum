...
class Associado extends Pessoa {
    ...
    public Associado(String nome, String rg, String cpf) {
        super(nome, rg, cpf, "", "", "");
        faltas = new HashMap<>();
    }

    public void adicionarFalta(String atividade) {
        if (faltas.containsKey(atividade)) {
            faltas.put(atividade, faltas.get(atividade) + 1);
        } else {
            faltas.put(atividade, 1);
        }
    }

    public int getFaltas(String atividade) {
        return faltas.getOrDefault(atividade, 0);
    }
...
public class AssociadosAtividades {
    public static void main(String[] args) {
        ...
        do {
            ...
            System.out.println("6 - Adicionar falta a um associado");
            System.out.println("7 - Visualizar faltas de um associado");
            ...
            switch (opcao) {
                ...
                case 5:
                    ...
                    break;
                case 6:
                    adicionarFalta(atividades, associados);
                    break;
                case 7:
                    visualizarFaltasAssociado(atividades, associados);
                    break;
            }
        } while (opcao != 0);
    }
    ...
    public static void adicionarAssociado(List<Associado> associados) {
        ...
        Associado novoAssociado = new Associado(nome, rg, cpf);
    ...
    public static void adicionarFalta(List<Atividade> atividades, List<Associado> associados) {
        Scanner scanner = new Scanner(System.in);
        ...
        System.out.println("Escolha a atividade para adicionar falta:");
        visualizarAtividadesCadastradas(atividades);
        ...
        if (opcaoAtividade >= 0 && opcaoAtividade < atividades.size()) {
            Atividade atividadeSelecionada = atividades.get(opcaoAtividade);
            associado.adicionarFalta(atividadeSelecionada.getNome());

            System.out.println("Falta adicionada com sucesso.");
        } else {
            System.out.println("Atividade não encontrada.");
        }
    }

    public static void visualizarFaltasAssociado(List<Atividade> atividades, List<Associado> associados) {
        Scanner scanner = new Scanner(System.in);
        ...
        System.out.println("Faltas do associado " + nomeAssociado + ":");
        Map<String, Integer> faltas = associado.getFaltas();
        for (String atividade : faltas.keySet()) {
            int numFaltas = faltas.get(atividade);
            System.out.println("Atividade: " + atividade + " - Faltas: " + numFaltas);
        }
    }
